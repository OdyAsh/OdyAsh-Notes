...
<br>![Screenshot of the Power BI report described in the previous paragraph.](https://learn.microsoft.com/en-us/training/wwl-data-ai/choose-power-bi-model-framework/media/model-frameworks-analytic-query-example.png)<br>
...
<br>![Animated diagram shows the incremental refresh and real-time data set up, and it highlights the Get the latest data in real-time with DirectQuery option.](https://learn.microsoft.com/en-us/training/wwl-data-ai/choose-power-bi-model-framework/media/model-framework-incremental-refresh.png)<br>
